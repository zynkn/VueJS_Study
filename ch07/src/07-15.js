...
var p1 = new Person('이몽룡', '010-123-1234', '경기도');
var p2 = new Person('홍길동', '010-3333-43444', '서울');

console.log(p1.toString());

console.log(Persone.getPersonCount());
...
let e1 = new Employee('이몽롱', '010-5555-1111', '서울시', 'A123', '회계팀');
